    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "middle_name",
                    models.CharField(blank=True, max_length=50, verbose_name="Отчество"),
                ),
                (
                    "email",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency",
                    models.PositiveIntegerField(default=0, verbose_name="Валюта"),
                ),
                (
                    "is_active",
                    models.BooleanField(default=True, verbose_name="Активный персонаж или нет"),
                ),
                (
                    "role",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_received",
                    models.BooleanField(default=False, verbose_name="Получена компетенция или нет"),
                ),
                (
                    "character",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "end_datetime",
                    models.DateTimeField(blank=True, null=True, verbose_name="Завершена"),
                ),
                (
                    "result",
                    models.TextField(blank=True, verbose_name="Результат выполнения события"),
                ),
                (
                    "inspector_comment",
                    models.TextField(blank=True, verbose_name="Комментарий проверяющего"),
                ),
                (
                    "character",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.TextField(blank=True, verbose_name="Результат выполнения миссии"),
                ),
                (
                    "inspector_comment",
                    models.TextField(blank=True, verbose_name="Комментарий проверяющего"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_received",
                    models.BooleanField(default=False, verbose_name="Получен ранг или нет"),
                ),
                (
                    "character",
                    models.ForeignKey(
