...
class Competency(AbstractBaseModel):
    """
    Компетенция - это умения и навыки, которы работник может получить в ходе выполнения миссий и событий.
    Например, в ходе посещения лекции по технике безопасности, работник может прокачать компетенцию "Безопасная работа"
    """
