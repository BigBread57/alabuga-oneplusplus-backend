...
REALM_NAME = config(
    "REALM_NAME",
    default="Django Integration" # задается при создании Realm
)
KEYCLOAK_URL_BASE = config(
    "KEYCLOAK_URL_BASE",
    default="http://localhost:8080/auth/" # базой url Keycloak
)
KEYCLOAK_AUDIENCE = config(
    "KEYCLOAK_AUDIENCE",
    default="account" # область Client - про это поговорим ниже
)
