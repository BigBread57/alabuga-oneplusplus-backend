    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Название категории активности",
                        max_length=256,
                ...
                (
                    "description",
                    models.TextField(
                        help_text="Описание категории активности",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Название игрового мира",
                        max_length=256,
                        unique=True,
                        verbose_name="Название",
                    ),
                ...
                (
                    "description",
                    models.TextField(help_text="Описание игрового мира", verbose_name="Описание"),
                ),
                ("color", models.CharField(max_length=256, verbose_name="Цвет")),
                (
                    "standard_experience",
                ...
                (
                    "currency_name",
                    models.CharField(help_text="Название валюты", verbose_name="Название валюты"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_id",
                    models.PositiveIntegerField(help_text="Id объекта", verbose_name="Id объекта"),
                ),
            ],
            options={
                "verbose_name": "Настройка игрового мира",
                "verbose_name_plural": "Настройки игровых миров",
                "ordering": ("-id",),
                "abstract": False,
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.TextField(help_text="Описание истории, лора", verbose_name="Текст"),
                ),
                (
                    "object_id",
                    models.PositiveIntegerField(help_text="Id объекта", verbose_name="Id объекта"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.ImageField(blank=True, null=True, upload_to="events", verbose_name="Иконка"),
                ),
                (
                    "color",
                    models.CharField(blank=True, max_length=256, verbose_name="Цвет"),
                ...
                (
                    ...
                    models.IntegerField(
                        default=1,
                        help_text="Порядок в ветке",
                        verbose_name="Порядок в ветке",
                    ),
                ),
                (
                    "is_key_mission",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Активная миссия или нет",
                        verbose_name="Активная миссия или нет",
                    ),
                ),
                (
                    "time_to_complete",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Название ветки миссий",
                        max_length=256,
                        verbose_name="Название",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Название уровня миссии",
                        max_length=256,
                        verbose_name="Название",
                    ),
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Описание уровня миссии",
                        verbose_name="Описание",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Активно событие или нет",
                        verbose_name="Активно событие или нет",
                    ),
                ),
                (
                    "start_datetime",
